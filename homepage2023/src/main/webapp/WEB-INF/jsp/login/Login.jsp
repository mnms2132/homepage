	...
	<div class="mem_login">
		<div class="smartshool login">
			<div class="login_inp_wrap">
				<div class="login_inp">
					<form action="/login/actionLogin.do" name="frmGnrlLogin" method="post" id="frmGnrlLogin" onsubmit="retrun checkGnrlLogin(this)">
						<fieldset>
							...
							<span>
								...
								<input type="password" id="pwd" name="password" value="" class="inp" title="패스워드를 입력하세요." placeholder="패스워드를 밉력하세요." autocomplete="off">
							</span>
...
//카카오 키 정보 입력
Kakao.init('f5e944b2e4a6169d37ac424406c3d47e');
