           			...
           			<tr>
          				...
          				<td>
       						<select id="confmSeCode" name="confmSeCode">
                                ...
                                <option value="O" <c:if test="${result.confmSeCode eq 'O'}"></c:if>>승인완료</option>
                                <option value="X" <c:if test="${result.confmSeCode eq 'X'}"></c:if>>반려</option>
                            </select>
                        </td>
                    </tr>
                    <tr id="resn"  <c:if test="${result.confmSeCode ne 'X'}">style="disply:none;"</c:if>>
                    	<th>반려사유</th>
                    	<td>
                    		<textarea rows="5" id="returnResn" name="returnResn"><c:out value="${retult.returnResn}"/></textarea>
                    	</td>
                    </tr>
                </tbody>
            </table>
