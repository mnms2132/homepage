			...
			<div id="bbs_wrap">
				<div class="board_view">
					...
					<dl class="info_view">
						...
						<dd>
							<c:out
								value="${reservation.useBeginTime} ~ ${reservation.useEndTime}" />
						</dd>
						<dt>신청기간</dt>
						<dd>
							<c:out value="${reservation.reqstBgnde}" />
							~
							<c:out value="${reservation.reqstEndde}" />
						</dd>
						<dt>신청 가능한 인원</dt>
						<dd>
					...
					<div class="view_cont">
						<c:out value="${frstRegistPnttm.resveCn}" escapeXml="false" />
					</div>
				</div>
			</div>
